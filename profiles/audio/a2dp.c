...
#ifdef __TIZEN_PATCH__
	/* session will be NULL if configuration is aborted or
	endpoint did not reply for SetConfiguration cmd; hence
	check error conditions first before calling avdtp_get_device() */
