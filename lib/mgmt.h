...
#define MGMT_OP_REMOVE_DEV_WHITE_LIST	0x0035
...
#define MGMT_OP_READ_RSSI	0x0040
...
#define MGMT_OP_L2CAP_CONN_PARAM_UPDATE  0x0041
...
#define MGMT_OP_WRITE_SEC_CONN_HOST_SUPPORT  0x0042
...
#define MGMT_OP_READ_SEC_CONN_HOST_SUPPORT 0x0043
struct mgmt_rp_read_sec_conn_host_support {
	uint8_t status;
	uint8_t sec_conn_host_support;
} __packed;

#define MGMT_OP_WRITE_AUTH_PAYLOAD_TIMEOUT 0x0044
...
#define MGMT_OP_READ_AUTH_PAYLOAD_TIMEOUT 0x0045
...
#define MGMT_TX_TIMEOUT_ERROR 0x001C
...
#ifdef __TIZEN_PATCH__
	"Set Advertising Parameters", /* 0x0031 */
