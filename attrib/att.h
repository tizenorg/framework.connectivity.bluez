...
static inline void att_put_uuid32(bt_uuid_t src, void *dst)
{
	att_put_u32(src.value.u32, dst);
}
#endif
...
#ifdef __TIZEN_PATCH__
static inline bt_uuid_t att_get_uuid32(const void *ptr)
{
	bt_uuid_t uuid;

	bt_uuid32_create(&uuid, att_get_u32(ptr));
